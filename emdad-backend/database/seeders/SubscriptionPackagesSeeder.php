...
class SubscriptionPackagesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $subscriptionsDetails=[
            ["name"=>'basic',"type"=>2,"subscription_details"=>["superAdmin"=>1,"users"=>21,"paymentMethods"=>"cash/credit","delivery"=>"one_time_delivery/standing_order","warehouses"=>6,"addSuppliers"=>16,"item_in_each_requisition"=>11,"live_tracking"=>true,"price"=>"15.000"]],
            ["name"=>'sliver',"type"=>1,"subscription_details"=>
            ...
            ["name"=>'Gold',"type"=>2,"subscription_details"=>
        ...
        foreach ($subscriptionsDetails as $subscriptionsDetail) {
            ...
            "subscription_name"=>$subscriptionsDetail['name'],
