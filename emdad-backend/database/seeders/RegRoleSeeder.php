...
class RegRoleSeeder extends Seeder
{
    ...
    public function run()
    {
        $roles = [
            ...
            ["id" => 6, "name_en" => "Wharehouse manager", "name_ar" => "مدير المستودع", "type" => 'supplier', "for_reg" => 0],
            ...
            ["id" => 9, "name_en" => "Wharehouse officer", "name_ar" => "مسؤول المستودع", "type" => 'supplier', "for_reg" => 0],
            ...
            ["id" => 12, "name_en" => "Wharehouse manager", "name_ar" => "مدير المستودع", "type" => 'buyer', "for_reg" => 0],
            ...
            ["id" => 15, "name_en" => "Wharehouse officer", "name_ar" => "مسؤول المستودع", "type" => 'buyer', "for_reg" => 0],
        ...
        foreach ($roles as $role) {
            ...
            if ($role['type'] == 'buyer' && $role['name_en'] == 'Wharehouse manager') {
