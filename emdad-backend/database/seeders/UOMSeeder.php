...
class UOMSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $unit_of_measuerments = [
            ["id" => 1, "name_ar" => 'كيلو متر', "name_en" => "kilometer", "symbol" => "KM", "relation" => "%", "value" => "1000", "related_unit" => 0],
            ["id" => 2, "name_ar" => 'متر', "name_en" => "meter", "symbol" => "M", "relation" => "*", "value" => "1000", "related_unit" => 1],
            ["id" => 3, "name_ar" => 'سنتمتر', "name_en" => "centimeters", "symbol" => "CM", "relation" => "*", "value" => "100", "related_unit" => 2]
        ];
