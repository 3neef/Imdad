...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions=[
            ...
            ["name"=>"buyer_delivery_view","label"=>"BD2","category"=>"","description"=>"BD"],
            ["name"=>"supplier_rfq_reject","label"=>"SRFQ3","category"=>"","description"=>"SRFQ"],
            ["name"=>"supplier_rfq_accept","label"=>"SRFQ2","category"=>"","description"=>"SRFQ"],
            ["name"=>"supplier_rfq_view","label"=>"SRFQ1","category"=>"","description"=>"SRFQ"],
            ...
            ["name"=>"supplier_customer_view","label"=>"SMCS1","category"=>"","description"=>"SMCS"],
            ["name"=>"supplier_user_inter","label"=>"SMU4","category"=>"","description"=>"SMU"],
