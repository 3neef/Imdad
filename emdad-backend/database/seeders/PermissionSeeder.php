...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            ["name" => "supplier_category_prdouct_managment_request_add", "label" => "SMCT1", "category" => "SMCT", "description" => ""],
            ...
            ["name" => "buyer_User_Management_activating", "label" => "BMU5", "category" => "BMU", "description" => ""],
            ...
            ["name" => "buyer_Category_and_Products_Management_adding", "label" => "BMCT1", "category" => "BMCT", "description" => ""],
            ["name" => "buyer_Category_and_Products_Management_Requesting", "label" => "BMCT12", "category" => "BMCT", "description" => ""],
