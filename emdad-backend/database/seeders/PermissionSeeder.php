...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            ["name" => "buyer_supplier_Partenership_freeze", "label" => "BMCD4", "category" => "BMCD", "description" => ""],
            ["name" => "buyer_supplier_Rejecting_and_Accepting", "label" => "BMCD3", "category" => "BMCD", "description" => ""],
            ["name" => "buyer_supplier_Adding_and_request_to_join", "label" => "BMCD2", "category" => "BMCD", "description" => ""],
            ["name" => "buyer_supplier_Viewing_suppliers_profile", "label" => "BMCD1", "category" => "BMCD", "description" => ""],
            ["name" => "buyer_User_Management_Entering_to_users_account", "label" => "BMU4", "category" => "BMU", "description" => ""],
            ["name" => "buyer_User_Management_Accepting_rejecting_activating_and_editing", "label" => "BMU3", "category" => "BMU", "description" => ""],
            ...
            ["name" => "buyer_Category_and_Products_Management_Requesting_and_adding", "label" => "BMCT2", "category" => "BMCT", "description" => ""],
            ...
            ["name" => "buyer_Bussiness_Mail_Creating_approving_and_closing_agreements", "label" => "BMMB2", "category" => "BMMB", "description" => ""],
            ...
            ["name" => "buyer_Credit_Agreements_Requesting_rejecting_and_accepting", "label" => "BMCT2", "category" => "BMCT", "description" => ""],
            ["name" => "buyer_Credit_Agreements_Viewing", "label" => "BMCT1", "category" => "BMCT", "description" => ""],
