...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            ["id" => 61, "name" => "buyer_supplier_Partenership_freeze", "lable" => "BMCD4", "category" => "BMCD", "description"],
            ["id" => 62, "name" => "buyer_supplier_Rejecting_and_Accepting", "lable" => "BMCD3", "category" => "BMCD", "description"],
            ["id" => 63, "name" => "buyer_supplier_Adding_and_request_to_join", "lable" => "BMCD2", "category" => "BMCD", "description"],
            ["id" => 64, "name" => "buyer_supplier_Viewing_suppliers_profile", "lable" => "BMCD1", "category" => "BMCD", "description"],
            ["id" => 65, "name" => "buyer_User_Management_Entering_to_users_account", "lable" => "BMU4", "category" => "BMU", "description"],
            ["id" => 66, "name" => "buyer_User_Management_Accepting_rejecting_activating_and_editing", "lable" => "BMU3", "category" => "BMU", "description"],
            ["id" => 67, "name" => "buyer_User_Management_Adding", "lable" => "BMU2", "category" => "BMU", "description"],
            ["id" => 68, "name" => "buyer_User_Management_Viewing", "lable" => "BMU1", "category" => "BMU", "description"],
            ["id" => 69, "name" => "buyer_User_Live_Communication_All_company_messeges", "lable" => "BML2", "category" => "BML", "description"],
            ["id" => 70, "name" => "buyer_User_Live_Communication_User's_own_messages", "lable" => "BML1", "category" => "BML", "description"],
            ["id" => 71, "name" => "buyer_Company_Account_and_Subscription_Requesting_subscription_freeze_for_a_period", "lable" => "BMCO3", "category" => "BMCO", "description"],
            ["id" => 72, "name" => "buyer_Company_Account_and_Subscription_Viewing_subscription_and_upgarde", "lable" => "BMCO2", "category" => "BMCO", "description"],
            ["id" => 73, "name" => "buyer_Company_Account_and_Subscription_Viewing_company_profile", "lable" => "BMCO1", "category" => "BMCO", "description"],
            ["id" => 74, "name" => "buyer_Category_and_Products_Management_Requesting_and_adding", "lable" => "BMCT2", "category" => "BMCT", "description"],
            ["id" => 75, "name" => "buyer_Category_and_Products_Management_Viewing", "lable" => "BMCT1", "category" => "BMCT", "description"],
            ["id" => 76, "name" => "buyer_Notifications_All_company_notifications", "lable" => "BMNM2", "category" => "BMNM", "description"],
            ["id" => 77, "name" => "buyer_Notifications_User's_own_notifications", "lable" => "BMNM1", "category" => "BMNM", "description"],
            ["id" => 78, "name" => "buyer_Alrts_Box_Viewing", "lable" => "BMCA2", "category" => "BMCA", "description"],
            ["id" => 79, "name" => "buyer_Bussiness_Mail_Creating_approving_and_closing_agreements", "lable" => "BMMB2", "category" => "BMMB", "description"],
            ["id" => 80, "name" => "buyer_Bussiness_Mail_Viewing", "lable" => "BMMB1", "category" => "BMMB", "description"],
            ["id" => 81, "name" => "buyer_Adding_More_Company_Adding", "lable" => "BMCD1", "category" => "BMCD", "description"],
            ["id" => 82, "name" => "buyer_Credit_Agreements_Requesting_rejecting_and_accepting", "lable" => "BMCT2", "category" => "BMCT", "description"],
            ["id" => 83, "name" => "buyer_Credit_Agreements_Viewing", "lable" => "BMCT1", "category" => "BMCT", "description"],
            ["id" => 84, "name" => "buyer_Digital_Engines_Apps_All_company_reports", "lable" => "BMDE2", "category" => "BMDE", "description"],
            ["id" => 85, "name" => "buyer_Digital_Engines_Apps_User's_own_reports", "lable" => "BMDE1", "category" => "BMDE", "description"],
        ];
