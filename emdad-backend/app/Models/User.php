...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'firstname', 'lastname', 'name', 'email', 'password', 'phone',
         'status', 'is_verified', 'default_company', 'avatar', 'otp', 
         'otp_expires_at', 'forget_pass','otp_used', 'mobile'
    ];
    ...
    public function roleInCompany(){
        return $this->belongsToMany(Role::class,'roles_users_company_info','users_id','roles_id')->withTimestamps();
    }
